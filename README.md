...
Assumed protobuf is built on power and installed in the location - /opt/DL/protobuf and jdk 8 is installed on your environment.
```bash
$ git clone -b ppc-grpc https://github.com/abdasgupta/grpc-java-ppc64le.git grpc-java
$ cd grpc-java
$ export PROTOC=/opt/DL/protobuf/bin/protoc
$ export CXXFLAGS="-I/opt/DL/protobuf/include"
$ export LDFLAGS="-L/opt/DL/protobuf/lib/"
$ ./gradlew build --info -Pprotoc=$PROTOC -PprotoInclude="/opt/DL/protobuf/include/" -PprotoLib="/opt/DL/protobuf/lib" --continue
$ export  GRPC_JAVA_PLUGIN=`pwd`/compiler/build/artifacts/java_plugin/protoc-gen-grpc-java.exe
```
